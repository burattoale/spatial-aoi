from typing import List, Any, Union # Changed str|int to Any for broader Python versions
...
class SimulationParameters(object):
    ...
    zeta: Union[float, List[float], np.ndarray]      # Node transmission attempt rate
